...
<div class="admonition note">
  ...
  <ol>
  <li> Run <code>aea -s upgrade</code> from within your AEA project. Then manually update <code>aea_version</code> in the <code>aea-config.yaml</code> to <code>'>=0.9.0, <0.10.0'</code>. If you have any errors during this step then please log them <a href="https://github.com/fetchai/agents-aea/issues/2133">on this GitHub issue</a> and reach out on Discord (we hope to fix them very soon!). Additional instructions can be found <a href="../../aea/upgrading" target="_blank">here</a>.</li>
