...
<div class="admonition note">
  <p class="admonition-title">Note</p>
  <p>If you're using an AEA which has been developed for a version of the AEA framework lower than `0.9.0` then please follow these steps:
  <ol>
  <li> Run <code>aea -s upgrade</code> from within your AEA project. If you have any errors during this step then please reach out on Discord.</li>
