...
Transaction fees serve _two crucial functions_:

* Compensate miners or validators assisting and confirming the transactions.

* Defend the network against spam assaults: this because transaction fees lead to a decrease in spam on the network, and large-scale spam assaults become more expensive and more difficult to execute.

    _Transaction fees thus serve as a basic but efficient spam filter._
