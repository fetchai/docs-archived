		...
		! function(e, n) {
			...
			function N(e, t, r, o) {
				...
				if (g || p > 1 && "string" == typeof d && !pe.checkClone && nt.test(d)) return e.each(function(n) {
					var i = e.eq(n);
					g && (t[0] = d.call(this, n, i.html())), N(i, t, r, o)
				});
			...
			var xe = function(e) {
					...
					var o = n.length > 0,
						...
						s = function(r, s, a, u, c) {
							var l, f, p, h = 0,
								...
								w = x.length;
							for (c && (N = s === L || s || c); d !== w && null != (l = x[d]); d++) {
								if (i && l) {
				...
				var w, T, C, j, k, E, S, A, N, q, D, O, L, H, F, R, I, P, M, $ = "sizzle" + 1 * new Date,
					W = e.document,
					B = 0,
					_ = 0,
					U = n(),
			...
			de.fn.extend({
				...
				de.fn[e] = function(n, r) {
					...
					return "Until" !== e.slice(-5) && (r = n), r && "string" == typeof r && (o = de.filter(r, o)), this.length > 1 && (Ne[e] || de.uniqueSort(o), Ae.test(e) && o.reverse()), this.pushStack(o)
				}
			});
			var qe = /[^\x20\t\r\n\f]+/g;
			...
			de.extend({
				...
				clone: function(e, t, n) {
					...
					if (!(pe.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || de.isXMLDoc(e)))
						for (s = v(a), i = v(e), r = 0, o = i.length; r < o; r++) A(i[r], s[r]);
					if (t)
						if (n)
			...
			de.param = function(e, t) {
				...
				serializeArray: function() {
					return this.map(function() {
						...
						var e = this.type;
						return this.name && !de(this).is(":disabled") && Nt.test(this.nodeName) && !At.test(e) && (this.checked || !ze.test(e))
					}).map(function(e, t) {
						var n = de(this).val();
		...
		(function(e) {
			...
			n.resolve = function() {
				...
				for (var t = -1, n = 0, r = -1, o = !0, i = 0, s = e.length - 1; s >= 0; --s) {
					...
					if (47 !== a) r === -1 && (o = !1, r = s + 1), 46 === a ? t === -1 ? t = s : 1 !== i && (i = 1) : t !== -1 && (i = -1);
					else if (!o) {
						n = s + 1;
						break
					}
				}
				return t === -1 || r === -1 || 0 === i || 1 === i && t === r - 1 && t === n + 1 ? "" : e.slice(t, r)
			};
			...
			! function(r) {
				...
				function p(e) {
					var t, n, r, i, s, a, l, p, h, d, g = [],
						...
						y = A,
						x = S;
					for (n = e.lastIndexOf(N), n < 0 && (n = 0), r = 0; r < n; ++r) e.charCodeAt(r) >= 128 && o("not-basic"), g.push(e.charCodeAt(r));
					for (i = n > 0 ? n + 1 : 0; i < m;) {
				...
				function h(e) {
					...
					for (e = a(e), m = e.length, t = A, n = 0, s = S, u = 0; u < m; ++u) g = e[u], g < 128 && b.push(R(g));
					for (r = i = b.length, i && b.push(N); r < m;) {
	...
	8: [function(e, t, n) {
		...
		r.prototype.parse = function(e, t, n) {
			...
			if (!T[h] && (k || h && !C[h])) {
				...
				var N, q;
				q = E === -1 ? a.lastIndexOf("@") : a.lastIndexOf("@", E), q !== -1 && (N = a.slice(0, q), a = a.slice(q + 1), this.auth = decodeURIComponent(N)), E = -1;
			...
			for (var E = w.slice(-1)[0], S = (n.host || e.host || w.length > 1) && ("." === E || ".." === E) || "" === E, A = 0, N = w.length; N >= 0; N--) E = w[N], "." === E ? w.splice(N, 1) : ".." === E ? (w.splice(N, 1), A++) : A && (w.splice(N, 1), A--);
			if (!x && !b)
				for (; A--; A) w.unshift("..");
